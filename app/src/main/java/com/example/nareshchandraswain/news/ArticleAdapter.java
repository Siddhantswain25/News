...
class ArticleAdapter extends ArrayAdapter<com.example.nareshchandraswain.news.BaseArticleData> {
    private static final String LOG_TAG = ArticleAdapter.class.getSimpleName();

    // Get article list
    ArticleAdapter(Context context, List<com.example.nareshchandraswain.news.BaseArticleData> articleList) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        // Get current article
        com.example.nareshchandraswain.news.BaseArticleData currentArticle = getItem(position);
