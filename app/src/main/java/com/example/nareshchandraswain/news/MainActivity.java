package com.example.nareshchandraswain.news;
...
import com.example.nareshchandraswain.news.R;
...
import static com.example.nareshchandraswain.news.QueryUtils.getPagesCount;

public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<com.example.nareshchandraswain.news.BaseArticleData>> {

    // Adapter for the articles
    private com.example.nareshchandraswain.news.ArticleAdapter articleAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articleAdapter = new com.example.nareshchandraswain.news.ArticleAdapter(MainActivity.this, new ArrayList<com.example.nareshchandraswain.news.BaseArticleData>());
        ...
        articleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                // Get selected object
                final com.example.nareshchandraswain.news.BaseArticleData articleSelected = articleAdapter.getItem(position);
        ...
        fromDateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DialogFragment newFragment = new com.example.nareshchandraswain.news.DatePickerFragment();
                // Send date type
    ...
    @Override
    public Loader<List<com.example.nareshchandraswain.news.BaseArticleData>> onCreateLoader(int id, Bundle args) {
        //noinspection unchecked
        return new com.example.nareshchandraswain.news.ArticleLoader(MainActivity.this, args);
    }

    // On load finished
    @Override
    public void onLoadFinished(Loader<List<com.example.nareshchandraswain.news.BaseArticleData>> loader, List<com.example.nareshchandraswain.news.BaseArticleData> data) {
        // Clear adapter
        if (articleAdapter != null)
            articleAdapter.clear();
    ...
    // When loader reset
    @Override
    public void onLoaderReset(Loader<List<com.example.nareshchandraswain.news.BaseArticleData>> loader) {
        //Reset adapter
        if (articleAdapter != null) {
            articleAdapter.clear();
        }
